...
<p align="center">
  <a href="https://malwadkarrohan03-dev.github.io/X-SyncTrace"><img src="https://img.shields.io/badge/Live%20Demo-Online-brightgreen?style=for-the-badge" alt="Live Demo"/></a>
...
👉 **[https://malwadkarrohan03-dev.github.io/X-SyncTrace](https://malwadkarrohan03-dev.github.io/X-SyncTrace)**
...
1. Download [`xsynctrace_collector.py`](xsynctrace_collector.py) and run it on the target Windows machine:
   ...
   ```
2. It will generate `xsynctrace_export.json` with a SHA-256 hash chain of custody record.
...
**Made for forensic professionals by forensic enthusiasts.**<img width="1893" height="906" alt="Screenshot 2026-05-07 182732" src="https://github.com/user-attachments/assets/b77fb359-8990-4b95-a39a-c36d08e614e2" />
